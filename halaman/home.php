...
<body>
    <div class="container mt-5">
        <h1 class="text-center mt-5">Selamat Datang di EzPhone</h1>
        ...
        <div class="text-center mt-5">
            <a href="rekomendasi.php" class="btn btn-primary btn-lg btn-animated">Mulai Rekomendasi</a>
        </div>
    </div>
<br><br>
